...
india_image=ImageTk.PhotoImage(Image.open("india map.jpg"))
usa_image=ImageTk.PhotoImage(Image.open("usa map.jpg"))
aus_image=ImageTk.PhotoImage(Image.open("australia.jpg"))
jap_image=ImageTk.PhotoImage(Image.open("japan map.png"))
...
aus_time=Label(root)
aus_time.place(relx=0.25,rely=0.80,anchor=CENTER)
...
jap_time=Label(root)
jap_time.place(relx=0.7,rely=0.80,anchor=CENTER)
